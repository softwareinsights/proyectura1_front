...
@Component({
  ...
  styleUrls: [('./cotizacions-add-modal.component.scss')],
  templateUrl: './cotizacions-add-modal.component.html'
})
export class CotizacionsAddModalComponent extends DialogComponent<CotizacionsInterface, any> implements OnInit {
