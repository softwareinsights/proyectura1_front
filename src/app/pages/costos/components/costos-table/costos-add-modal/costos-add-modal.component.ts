...
@Component({
  ...
  styleUrls: [('./costos-add-modal.component.scss')],
  templateUrl: './costos-add-modal.component.html'
})
export class CostosAddModalComponent extends DialogComponent<CostosInterface, any> implements OnInit {
  _material: string[] = [];
