...
@Component({
  ...
  styleUrls: [('./detallefacturas-add-modal.component.scss')],
  templateUrl: './detallefacturas-add-modal.component.html'
})
export class DetallefacturasAddModalComponent extends DialogComponent<DetallefacturasInterface, any> implements OnInit {
  _factura: string[] = [];
  _material: string[] = [];
