...
@Component({
  ...
  styleUrls: [('./detallenotagastos-add-modal.component.scss')],
  templateUrl: './detallenotagastos-add-modal.component.html'
})
export class DetallenotagastosAddModalComponent extends DialogComponent<DetallenotagastosInterface, any> implements OnInit {
  _notagasto: string[] = [];
  _material: string[] = [];
