...
export class StatusrazonsocialsService {
    ...
    constructor(
        ...
        this.endPoint = `${this._configuration.ServerWithApiUrl}statusrazonsocial`;
       }
       ...
       findById = ( id ) : Observable<StatusrazonsocialsResponseInterface> => {
           return this._http.get(`${this.endPoint}/${id}`, this.options)
               .map((response: Response) => response.json())
               .catch(this.handleError);
       }
       update = ( statusrazonsocial: StatusrazonsocialsInterface ) : Observable<StatusrazonsocialsResponseInterface> => {
           return this._http.patch(this.endPoint, statusrazonsocial, this.options)
               .map((response: Response) => response.json())
               .catch(this.handleError);
       }
       ...
       insert = ( statusrazonsocial: StatusrazonsocialsInterface ) : Observable<StatusrazonsocialsResponseInterface> => {
           return this._http.post(this.endPoint, statusrazonsocial, this.options)
               .map((response: Response) => response.json())
               .catch(this.handleError);
       }
