...
@Component({
  ...
  styleUrls: [('./tipomaterials-add-modal.component.scss')],
  templateUrl: './tipomaterials-add-modal.component.html'
})
export class TipomaterialsAddModalComponent extends DialogComponent<TipomaterialsInterface, any> implements OnInit {
