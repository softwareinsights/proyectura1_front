...
@Component({
  ...
  styleUrls: [('./detallecotizacions-edit-modal.component.scss')],
  templateUrl: './detallecotizacions-edit-modal.component.html'
})
export class DetallecotizacionsEditModalComponent extends DialogComponent<DetallecotizacionsInterface, any> implements OnInit, DetallecotizacionsInterface {
  _cotizacion: string[] = [];
  _categoria: string[] = [];
