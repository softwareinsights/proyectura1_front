...
@Component({
  ...
  styleUrls: [('./usuarios-edit-modal.component.scss')],
  templateUrl: './usuarios-edit-modal.component.html'
})
export class UsuariosEditModalComponent extends DialogComponent<UsuariosInterface, any> implements OnInit, UsuariosInterface {
  _rol: string[] = [];
