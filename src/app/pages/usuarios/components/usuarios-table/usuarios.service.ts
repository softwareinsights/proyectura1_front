...
export class UsuariosService {
    ...
    constructor(
        ...
        this.endPoint = `${this._configuration.ServerWithApiUrl}usuario`;
       }
       ...
       update = ( usuario: UsuariosInterface ) : Observable<UsuariosResponseInterface> => {
           return this._http.patch(this.endPoint, usuario, this.options)
               .map((response: Response) => response.json())
               .catch(this.handleError);
       }
       ...
       insert = ( usuario: UsuariosInterface ) : Observable<UsuariosResponseInterface> => {
           return this._http.post(this.endPoint, usuario, this.options)
               .map((response: Response) => response.json())
               .catch(this.handleError);
       }
