...
@Component({
  ...
  styleUrls: [('./obracategorias-add-modal.component.scss')],
  templateUrl: './obracategorias-add-modal.component.html'
})
export class ObracategoriasAddModalComponent extends DialogComponent<ObracategoriasInterface, any> implements OnInit {
  _obra: string[] = [];
  _categoria: string[] = [];
