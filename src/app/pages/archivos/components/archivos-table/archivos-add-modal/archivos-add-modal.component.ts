...
@Component({
  ...
  styleUrls: [('./archivos-add-modal.component.scss')],
  templateUrl: './archivos-add-modal.component.html'
})
export class ArchivosAddModalComponent extends DialogComponent<ArchivosInterface, any> implements OnInit {
  _referencia: string[] = [];
