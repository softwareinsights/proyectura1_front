...
@Component({
  ...
  styleUrls: [('./notagastos-edit-modal.component.scss')],
  templateUrl: './notagastos-edit-modal.component.html'
})
export class NotagastosEditModalComponent extends DialogComponent<NotagastosInterface, any> implements OnInit, NotagastosInterface {
  _razonsocial: string[] = [];
