...
@Component({
  ...
  styleUrls: [('./unidadmedidas-edit-modal.component.scss')],
  templateUrl: './unidadmedidas-edit-modal.component.html'
})
export class UnidadmedidasEditModalComponent extends DialogComponent<UnidadmedidasInterface, any> implements OnInit, UnidadmedidasInterface {
